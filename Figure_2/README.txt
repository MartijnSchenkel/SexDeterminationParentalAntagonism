./analysis_script.R 
  The file runs the entire analysis required to generate Figure 2 in the manuscript.
  ...
  to generate the .PDF and .PNG versions of Figure 2 (included in ./figure_files). 
  Included in /figure_files are also some plots generated using the raw data on the 
  frequency of s_22 in different simulations.
